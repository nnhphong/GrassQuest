...
function Game({setView}) {
  return (
    <div className="bg-slate-800 h-[calc(100vh-5rem)] bg-cover flex flex-col justify-center">
        <div className="flex flex-col justify-center items-center mb-10">
            ...
            <button className="mt-4 bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 border border-blue-700 rounded w-9/12 h-12">
                Hint
            </button>
        </div>
    </div>
